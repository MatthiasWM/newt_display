...
/*
 This is the driver for the GDEH0576T81 ePaper display.
 
 The display has a resolution of 920*680 pixels. It is controlled via SPI
 3 wire using a SSD2677 controller. Four levels of gray can be acheived.
